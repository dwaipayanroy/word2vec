...
int main(int argc, char **argv) {
    ...
    for (b = 0; b < words; b++) {
		...
		// +++Debasis: Debug
		for (a = 0; a < size; a++) fprintf(fp, "%f ", M[a + b* size]); fprintf(fp, "\n");
    ...
    while (1) {
        ...
        for (a = 0; a < N; a++) bestw[a][0] = 0;
		printf("composed vector: ");
    	for (a = 0; a < size; a++) printf("%f ", vec[a]); printf("\n");
		...
		printf("best matching vector: ");
		for (a = 0; a < size; a++) printf("%f ", M[a + best_index * size]); printf("\n");
    }
    return 0;
}
